...
// import { MonthlyAssignmentStatus } from "../Compunents/StudentAssignmentChart/AssignmentChart";
...
const DashboardsT = () => {
	...
	return (
		<div className=" lg:ml-24 md:ml-24 sm:ml-4 mx-auto my-24">
			...
			{/* <header className="flex items-center justify-between p-4 mb-5 bg-gray-100 rounded-xl">
				<div className="">
				...
				<div className="flex items-center gap-3">
					<div className="text-center">
						<p className="text-sm  text-[#0782e0] font-medium">
					...
					<Avatar className={"bg-[#0782e0] flex items-center justify-self"}>
						<AvatarImage src={user?.profileImage} />
						<AvatarFallback className={"font-bold text-white"}>
							{user ? user.name.slice(0, 2).toUpperCase() : "Guest"} 
						</AvatarFallback>
					</Avatar>
				</div>
			</header> */}
			...
			<div className="bg-[#0782e0] h-60 flex items-center justify-between px-6 rounded-2xl w-full">
				<div className={`w-2/2 flex flex-row justify-start`}>
					<div className="text-left">
						<p className=" text-slate-200 font-bold text-xl">{currentDate}</p> {/* Dynamic Date */}
						<h1 className="mt-2 text-xl font-bold text-white sm:text-xl">
							Welcome back, {user ? user.name : "Guest"}! 👋 {/* User ka naam yahan */}
						</h1>
